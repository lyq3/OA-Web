...
var templates = [
    {
        "pre":"pre0.png",
        'title':lang.blank,
        'preHtml':'<h2 style="font-size: 32px; font-weight: bold; border-bottom: 2px solid red; padding: 0px 4px 50px 0px; text-align: center; margin: 0px 0px 20px;">\n' +
        '    <span style="color: rgb(255, 0, 0); font-family: 宋体, SimSun;">&nbsp;<strong>拉&nbsp; 萨&nbsp; 市&nbsp; 城&nbsp; 关&nbsp; 区&nbsp; 政&nbsp; 府</strong></span>\n' +
        '</h2>\n' +
        '<p>\n' +
        '    <span style="color: rgb(255, 0, 0); font-family: 宋体, SimSun;"><strong><br/></strong></span>\n' +
        '</p>',
        "html":'<h2 style="font-size: 32px; font-weight: bold; border-bottom: 2px solid red; padding: 0px 4px 50px 0px; text-align: center; margin: 0px 0px 20px;">\n' +
        '    <span style="color: rgb(255, 0, 0); font-family: 宋体, SimSun;">&nbsp;<strong>拉&nbsp; 萨&nbsp; 市&nbsp; 城&nbsp; 关&nbsp; 区&nbsp; 政&nbsp; 府</strong></span>\n' +
        '</h2>\n' +
        '<p>\n' +
        '    <span style="color: rgb(255, 0, 0); font-family: 宋体, SimSun;"><strong><br/></strong></span>\n' +
